...
def test_ground_truth_external_params_beat_a_deliberately_underfit_model(
    ...
    per_frame_error, _, _, _, _, _ = _test_reprojection_errors(test_frames, K_bad, D_bad, CameraModelType.PINHOLE)
...
def test_external_compare_view_exposes_undistortion_visual_comparison_modes():
    ...
    for label in [
        ...
        "Parameter Analysis",
        "Model Comparison",
        "Model Comparison: Ideal Pinhole / Brown-Conrady / Rational / Fisheye",
        "Hold-out RMSE",
        "Hold-out P95",
        "AIC",
        "BIC",
