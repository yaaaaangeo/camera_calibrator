...
def _project(
    ...
    실제 fisheye/pinhole 분기는 calibration.models.common.project_points_for_model
    로 옮겼다 - calibration/validation.py, calibration/windshield 패키지 등
    여러 곳이 같은 분기를 필요로 해서 한 곳에만 두기 위함(behavior 변경 없음).
    """
    return project_points_for_model(object_points, rvec, tvec, camera_matrix, distortion, model)
