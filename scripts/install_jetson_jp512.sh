...
echo
echo "주의: 이 Python 3.10 venv에서는 ROS1 Noetic Python 3.8 cv_bridge 기반"
echo "live topic을 직접 지원하지 않습니다. rosbag offline input을 쓰거나,"
echo "별도 Python 3.8 ROS bridge process / IPC bridge 구성을 사용하세요."
